...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: The div is used as a wrapper for form fields
		<div
	...
	const content = useMemo(() => {
		...
		return (
			<ul className="ml-4 flex list-disc flex-col gap-1">
				{uniqueErrors.map(
					(error, index) =>
						// biome-ignore lint/suspicious/noArrayIndexKey: Using index as key because error messages might be identical
