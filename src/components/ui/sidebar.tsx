...
function SidebarProvider({
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: We need to set the cookie here.
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: setOpenMobile is required here.
